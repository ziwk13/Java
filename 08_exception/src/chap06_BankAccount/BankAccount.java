...
public class BankAccount {
	...
	public void deposit(long money) throws DepositException {
		/* 구현 */
		if(money <= 0) {
			throw new DepositException("!!! 0원 이상의 금액을 넣어주세요 !!!");
		}
			balance += money;
			throw new DepositException(money + "원이 입금 되었습니다.\n 현재 잔액: " + balance + "원");
	}
	 ...
	 */
	public long withdrawal(long money) throws WithdrawalExcception {
		/* 구현 */
		if(money < 0) {
			throw new WithdrawalExcception("마이너스 금액은 출금이 불가능 합니다");
		}
		else if(money > balance) {
			throw new WithdrawalExcception("잔액 부족: 현재 잔액은 " + balance + "원 입니다 \n"
					+ "잔액을 확인 하시어 다시 출금을 해주세요");
		}
		 balance -= money;
		 return money;
	}
	 ...
	 */
	public void transfer(BankAccount bankAccount, long money) throws DepositException, WithdrawalExcception {
		/* 구현 */
